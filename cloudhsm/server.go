...
type Config struct {
	...
	Debug           bool          `help:"Enable debug mode" env:"CLOUDHSM_DEBUG" default:"false"`
...
func (c Config) ClientEnv() []core.EnvVar {
	return []core.EnvVar{
		{Key: "SAKURA_ENDPOINTS_CLOUDHSM", Value: "http://" + c.Addr},
	}
}

// Name returns the service's short name.
func (Config) Name() string { return "cloudhsm" }
